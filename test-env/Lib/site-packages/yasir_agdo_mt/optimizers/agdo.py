...
class AGDOConfig:
    """
 Configuration parameters for the Adam Gradient Descent Optimizer.

    Parameters
    ----------
    npop : int, default=120
    ...
    learning_rate : float or callable, default=0.05
        Constant learning rate or a scheduler function.
    ...
    levy_beta : float, default=1.5
        Levy flight exponent.
